...
int main (int argc, char** argv)
{
    ...
    svr.Get(R"(/publish/size=(\d+)/(.*))", [&](const httplib::Request& req, httplib::Response& res) {
        ...
        server_error_t ret = server_publish(req, res, global_eid);
        if(ret) {
    ...
    svr.Get(R"(/query/size=(\d+)/(.*))", [&](const httplib::Request& req, httplib::Response& res) { 
        ...
        server_error_t ret = server_query(req, res, global_eid);
        if(ret){
...
*/
    ...
    svr.Get(R"(/register/size=(\d+)/(.*))", [&](const httplib::Request& req, httplib::Response& res) { 
        ...
        if(server_error_t ret = server_register(req, res, global_eid)){
